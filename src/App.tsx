  ...
  const lithologyColumns = useMemo<GridColumn[]>(() => [
    ...
    { key: 'to', label: 'Depth To (m)', type: 'number', width: '8%', defaultValue: 0 },
    {
      ...
      options: [
        ...
        { value: 'ALUNIT', label: 'ALUNIT - Alunit Alterasyonu (ALN)' },
        { value: 'ANDEZIT', label: 'ANDEZIT - Andezit (AND)' },
        { value: 'BAZALT', label: 'BAZALT - Bazalt (BSL)' },
        { value: 'BRES', label: 'BRES - Breş (BRS)' },
        { value: 'BU', label: 'BU - Boş Karot' },
        { value: 'DASIT', label: 'DASIT - Dasit (DST)' },
        { value: 'DAYK', label: 'DAYK - Dayk (DYK)' },
        { value: 'DIYABAZ', label: 'DIYABAZ - Diyabaz (DB)' },
        { value: 'DIYORIT', label: 'DIYORIT - Diyorit (DYR)' },
        { value: 'DOLGU', label: 'DOLGU - Toprak / Dolgu (ALV)' },
        { value: 'FLT', label: 'FLT - Fay Zonu (MLK)' },
        { value: 'GABRO', label: 'GABRO - Gabro (GB)' },
        ...
        { value: 'HALLOYSIT', label: 'HALLOYSIT - Halloysit (HAL)' },
        { value: 'IGNIMBIRIT', label: 'IGNIMBIRIT - İgnimbirit (IGB)' },
        ...
        { value: 'KUVARS', label: 'KUVARS - Kuvars Damarı (QVN)' },
        ...
        { value: 'PEGMATIT', label: 'PEGMATIT - Pegmatit (PEG)' },
        ...
        { value: 'SILIS', label: 'SILIS - Silis Damarı (QVN)' },
