...
CREATE TABLE IF NOT EXISTS assays (
  ...
  cao DOUBLE PRECISION DEFAULT 0.0,
  mgo DOUBLE PRECISION DEFAULT 0.0,
  p2o5 DOUBLE PRECISION DEFAULT 0.0,
  sro DOUBLE PRECISION DEFAULT 0.0,
  so4 DOUBLE PRECISION DEFAULT 0.0,
  cr2o3 DOUBLE PRECISION DEFAULT 0.0,
  mno DOUBLE PRECISION DEFAULT 0.0,
  au_ppb DOUBLE PRECISION DEFAULT 0.0,
  au_ppm DOUBLE PRECISION DEFAULT 0.0,
  ag_ppm DOUBLE PRECISION DEFAULT 0.0,
  cu_ppm DOUBLE PRECISION DEFAULT 0.0,
  pb_ppm DOUBLE PRECISION DEFAULT 0.0,
  zn_ppm DOUBLE PRECISION DEFAULT 0.0,
  as_ppm DOUBLE PRECISION DEFAULT 0.0
);
