  ...
  const lithologyColumns = useMemo<GridColumn[]>(() => [
    ...
    { key: 'to', label: 'Depth To (m)', type: 'number', width: '8%', defaultValue: 0 },
    {
      ...
      options: [
        ...
        { value: 'ALUNIT', label: 'ALUNIT - Alunite / Alunit' },
        { value: 'ANDEZIT', label: 'ANDEZIT - Andesite / Tuff' },
        { value: 'BRES', label: 'BRES - Fault Breccia' },
        { value: 'BU', label: 'BU - Empty / Boş Karot' },
        { value: 'DASIT', label: 'DASIT - Dacite / Dasit' },
        { value: 'DAYK', label: 'DAYK - Dyke / Dayk' },
        { value: 'DOLGU', label: 'DOLGU - Overburden / Fill' },
        { value: 'FLT', label: 'FLT - Fault / Fay' },
        { value: 'GNAYS', label: 'GNAYS - Gneiss / Gnays' },
        { value: 'GNYS', label: 'GNYS - Gneiss / Gnays (Metallic)' },
        { value: 'GRA', label: 'GRA - Granite / Granit (Metallic)' },
        { value: 'GRANIT', label: 'GRANIT - Granite / Granit' },
        ...
        { value: 'INTRUZIF', label: 'INTRUZIF - Intrusive / İntruzif' },
        { value: 'KAHVERENGI', label: 'KAHVERENGI - Brownish Band' },
        { value: 'KALSIT', label: 'KALSIT - Calcite / Limestone' },
        { value: 'KAOLEN', label: 'KAOLEN - Kaolin / Kaolen' },
        { value: 'KAROT', label: 'KAROT - No Core / Karot Yok' },
        { value: 'KIL', label: 'KIL - Clay / Kil' },
        { value: 'KOMUR', label: 'KOMUR - Coal / Kömür' },
        { value: 'KUM', label: 'KUM - Sand / Kum' },
        { value: 'KUVARSIT', label: 'KUVARSIT - Quartzite' },
        { value: 'MRB', label: 'MRB - Marble / Mermer' },
        { value: 'MTSH', label: 'MTSH - Meta-shale / Meta-çamurtaşı' },
        { value: 'MTSL', label: 'MTSL - Meta-siltstone / Meta-silttaşı' },
        { value: 'MTSS', label: 'MTSS - Meta-sandstone / Hornfels' },
        { value: 'NONE', label: 'NONE - None / Belirsiz' },
        { value: 'OFY', label: 'OFY - Ophiolite / Ofiyolit' },
        { value: 'OKSIT', label: 'OKSIT - Oxide / Oksit' },
        { value: 'PERLIT', label: 'PERLIT - Perlite / Perlit' },
        { value: 'RIYOLIT', label: 'RIYOLIT - Rhyolite / Riyolit' },
        { value: 'SEDIMENT', label: 'SEDIMENT - Sediment / Tortul' },
        { value: 'SERP', label: 'SERP - Serpentinite / Serpantin' },
        { value: 'SILIS', label: 'SILIS - Silica / Silis' },
        { value: 'SIST', label: 'SIST - Schist / Şist' },
        { value: 'SIYENIT', label: 'SIYENIT - Syenite / Siyenit' },
        { value: 'SUBVOLKANIK', label: 'SUBVOLKANIK - Subvolcanic' },
        { value: 'SULFIT', label: 'SULFIT - Sulfide / Sülfit' },
        { value: 'TAZE', label: 'TAZE - Fresh Rock / Taze Kaya' },
        { value: 'TO', label: 'TO - Soil / Örtü Toprak' },
        { value: 'TOPRAK', label: 'TOPRAK - Soil / Nebati Toprak' },
        { value: 'UNC', label: 'UNC - Unconformity / Uyumsuzluk' },
        { value: 'VFD', label: 'VFD - Dacitic Tuff / Dasitik Tüf' },
        { value: 'VIA', label: 'VIA - Andesite / Andezit' },
        { value: 'VIA.A', label: 'VIA.A - Andesitic Agglomerate' },
        { value: 'VIA.P', label: 'VIA.P - Andesite Porphyry' },
        { value: 'VIA.T', label: 'VIA.T - Andesitic Tuff' },
        { value: 'VIA:T', label: 'VIA:T - Andesitic Tuff (Metallic)' },
        { value: 'VOLKANOSEDIMANTER', label: 'VOLKANOSEDIMANTER - Volcanosedimentary' },
        { value: 'VSM', label: 'VSM - Volcanosedimentary (Metallic)' },
        { value: 'XBH', label: 'XBH - Hydrothermal Breccia' },
        { value: 'YANAL', label: 'YANAL - Fault Zone / Kırık Zonu' },
